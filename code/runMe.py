...
def main():
    ...
    list_dir = 'code/data/INPUT/Carmen_Input/dataset_1'
    ...
    if action == 'single action':
        ...
        make_folder('code/data/OUTPUT', 'SINGLEMAP')
        paths.path_folder_output = 'code/data/OUTPUT/SINGLEMAP'
        ...
        paths.path_folder_output = os.path.join('code/data/OUTPUT', paths.name_folder_input)
        make_folder('code/data/OUTPUT', paths.name_folder_input)
        start_main(action, parameters_object, paths)
        ...
        paths.path_folder_output = os.path.join('code/data/OUTPUT', paths.name_folder_input)
        make_folder('code/data/OUTPUT', paths.name_folder_input)
        filename = os.path.join('code/data/OUTPUT/' + paths.name_folder_input, 'evaluation_sliding.txt')
        file = open(filename, 'w+')
...
def start_main(action, parameters_object, paths):
    ...
    if action == 'batch':
        ...
        for metric_map in glob.glob(paths.path_folder_input + '/*.png'):
            ...
            shutil.copy('/home/adityabprak0911/declutter-reconstruct/code/parameters.py', paths.filepath + '/parameters.py')
            # ----------------------------------------------------------------
            # orebro
            ...
            # ----------------------------------------------------------------
            # evaluation
            paths.gt_color = 'code/data/INPUT/gt_colored/' + paths.name_folder_input + '/' + paths.metric_map_name + '.png'
            # ----------------------------------------------------------------
            # starting main
    ...
    # -------------------EXECUTION---------------------------------------
        ...
        # copying the parameters file
        shutil.copy('/home/adityabprak0911/declutter-reconstruct/code/parameters.py', paths.path_log_folder + '/' + running_time + '/parameters')
        # ----------------------------------------------------------------
        # orebro
        ...
        # ----------------------------------------------------------------
        # evaluation
        paths.gt_color = 'code/data/INPUT/gt_colored/' + paths.name_folder_input + '/' + paths.metric_map_name
        # ----------------------------------------------------------------
        # starting main
        print('map name ', paths.metric_map_name)
        minibatch.start_main(par, parameters_object, paths)
